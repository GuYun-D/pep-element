import { defineComponent, resolveComponent, openBlock, createBlock, mergeProps, withCtx, createElementBlock, Fragment, renderList, resolveDynamicComponent, unref, createCommentVNode, createElementVNode, toDisplayString, createStaticVNode, useAttrs, createVNode, isVNode } from "vue";
const toLine = (value) => {
  return value.replace(/(A-Z)g/, "-$1").toLocaleLowerCase();
};
var index_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => "svg[data-v-efac84b8]{margin-right:4px;width:1em;height:1em}.el-menu-vertical-demo[data-v-efac84b8]:not(.el-menu--collapse){width:200px;min-height:400px}.el-menu--collapse .title-text[data-v-efac84b8]{margin-left:0}.title-text[data-v-efac84b8]{margin-left:10px}\n")();
...
const _hoisted_1$1 = { class: "title-text" };
const _hoisted_2$1 = { class: "title-text" };
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.data, (item) => {
            return openBlock(), createElementBlock(Fragment, {
              ...
              !item[__props.children] || !item[__props.children].length ? (openBlock(), createBlock(_component_el_menu_item, {
                ...
                default: withCtx(() => [
                  item[__props.icon] ? (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(item[__props.icon])}`), {
                    key: 0,
                    class: "icon"
                  })) : createCommentVNode("", true),
                  createElementVNode("span", _hoisted_1$1, toDisplayString(item[__props.name]), 1)
                ]),
                _: 2
              ...
              item[__props.children] && item[__props.children].length ? (openBlock(), createBlock(_component_el_sub_menu, {
                ...
                title: withCtx(() => [
                  ...
                  createElementVNode("span", _hoisted_2$1, toDisplayString(item[__props.name]), 1)
                ]),
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(item[__props.children], (item1) => {
                    return openBlock(), createBlock(_component_el_menu_item, {
                      key: item1[__props.name],
                      index: item1[__props.index]
                    }, {
                      default: withCtx(() => [
                        ...
                        createElementVNode("span", _hoisted_3$1, toDisplayString(item1[__props.name]), 1)
                      ]),
                      _: 2
                    }, 1032, ["index"]);
                  }), 128))
...
var PepMenu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-efac84b8"]]);
...
}, _hoisted_2 = /* @__PURE__ */ createElementVNode("path", {
  fill: "currentColor",
  d: "M288 896h448q32 0 32 32t-32 32H288q-32 0-32-32t32-32z"
}, null, -1), _hoisted_3 = /* @__PURE__ */ createElementVNode("path", {
  fill: "currentColor",
  d: "M800 416a288 288 0 1 0-576 0c0 118.144 94.528 272.128 288 456.576C705.472 688.128 800 534.144 800 416zM512 960C277.312 746.688 160 565.312 160 416a352 352 0 0 1 704 0c0 149.312-117.312 330.688-352 544z"
}, null, -1), _hoisted_4 = /* @__PURE__ */ createElementVNode("path", {
  fill: "currentColor",
...
var index$1 = /* @__PURE__ */ (() => ".pep-icon{margin-right:4px;width:1em;height:1em}\n")();
function _isSlot(s) {
  ...
  setup(props, ctx) {
    const renderMenu = (data) => {
      return data.map((item) => {
        ...
        const slots = {
          title: () => {
            return createVNode(Fragment, null, [createVNode(item.i, {
              "className": "pep-icon"
            }, null), createVNode("span", null, [item[props.name]])]);
          }
        };
