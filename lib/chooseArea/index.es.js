import { defineComponent, ref, watch, resolveComponent, openBlock, createElementBlock, createVNode, withCtx, Fragment, renderList, createBlock } from "vue";
var allArea = [
  {
    code: "11",
    name: "\u5317\u4EAC\u5E02",
...
const _sfc_main = defineComponent({
  ...
  setup(__props, { emit: emites }) {
    ...
    watch(() => city.value, (val) => {
      if (val) {
        seleteArea.value = selectCity.value.find((item) => item.code === city.value).children;
      }
      area.value = "";
    });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [
        ...
        createVNode(_component_el_select, {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectCity.value, (item) => {
              return openBlock(), createBlock(_component_el_option, {
                key: item.code,
                label: item.name,
                value: item.code
        ...
        createVNode(_component_el_select, {
          disabled: !province.value || !city.value,
          modelValue: area.value,
          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => area.value = $event),
          clearable: "",
          placeholder: "\u8BF7\u9009\u62E9\u533A\u57DF"
        }, {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(seleteArea.value, (item) => {
              return openBlock(), createBlock(_component_el_option, {
                key: item.code,
                label: item.name,
                value: item.code
...
var index = {
  install(app) {
    app.component("choose-area", _sfc_main);
  }
};
